...
function verificarCampos(){
    ...
    //console.log('função acionada'); verificar se está funcionando
    if(inputPeso.value != '' && inputAltura.value != ''){
        btnCalcular.removeAttribute('disabled');
            // != significa valor diferente
}
...
function calcularIMC(){    
    ...
    infoIMC.style.color = cor ;  //usar o .style o JS altera o CSS no HTML (JS manipula SEMPRE o HTML)
